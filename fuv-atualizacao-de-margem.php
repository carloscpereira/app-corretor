...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill fw-light mt-2 mb-0 mb-sm-2">Atualização de Margem</h1>
        ...
        <div class="block-header block-header-default">
            ...
            <div class="input-group input-group-lg">
                ...
                <div class="form-group col-4 mt-0 mb-0 custom-control">
                    <label class="mb-4">Margem Atual (R$)</label>
                ...
                <div class="form-group col-4 mt-0 mb-0 custom-control">
                    <label class="mb-4">Margem Usada (%)</label>
            ...
            <table class="table table-striped table-borderless table-vcenter">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="d-none d-md-table-cell text-center" style="width: 150px;">Margem Total</th>
                        <th class="d-none d-md-table-cell" style="width: 150px;">Margem Atual</th>
                        <th style="width: 150px;">Usada (R$)</th>
                        <th style="width: 150px;">Usada (%)</th>
                    </tr>
                </thead>
                <tbody id="myBody">
                </tbody>
