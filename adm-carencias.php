...
<div class="bg-body-light">
    <div class="content content-full">
        ...
        <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Gerenciando Carências</h1>        
            <nav class="flex-sm-00-auto ml-sm-3" aria-label="breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item">
                        <a href="dashboard.php">Home</a>
                    </li>
                    <li class="breadcrumb-item active" aria-current="page">Carências</li>
                </ol>
            </nav>
        </div>
   </div>
    ...
    <div class="block">
        <div class="block-header block-header-default">
            ...
            <div class="block-options">
                <button type="button" class="btn-block-option mr-2" onclick="window.location.href = 'adm-carencias-manage.php'">
                    <i class="fa fa-plus mr-1"></i> Nova Carência
                </button>
            ...
            <table class="table table-striped table-borderless table-vcenter">
                <thead class="thead-light">
                    <tr>
                        ...
                        <th class="d-none d-md-table-cell text-center" style="width: 100px;">Convênios</th>
                ...
                <tbody>
                    <tr>
                        <td colspan="2">
                            <a class="font-w600" href="adm-produtos-manage.php?id=2">Saúde Bucal Sempre</a>
                    ...
                    <tr>
                        <td colspan="2">
                            <a class="font-w600" href="adm-produtos-manage.php?id=2">Ganhe em Dobro</a>
                            <div class="font-size-sm text-muted mt-1">
                                <a href="be_pages_generic_profile.php"><?php $dm->get_name(); ?></a> on <em>May 26, 2018</em>
                            </div>
                        </td>
