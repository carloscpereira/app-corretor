<?php
    ...
    include('../funcoes/corretor/conexao.php');
    ...
    if ($idbeneficiario==null && !$deleted){
        $sql = "INSERT INTO dependentes (
                ...
                $vinculo) RETURNING dependenteid as id, titularid as idproposta, nome, nascimento, 
                                    ...
                                    idvinculo";
    } else if($idbeneficiario != null && !$deleted) {
        ...
        $sql = "DELETE FROM dependentes WHERE dependenteid = $idbeneficiario RETURNING *";
    }else {
        return true;
    }
