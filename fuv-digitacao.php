...
<div class="bg-body-light">
    <div class="content content-full">
        <div class="d-flex flex-column flex-sm-row justify-content-sm-between align-items-sm-center">
            <h1 class="flex-sm-fill font-size-h2 font-w400 mt-2 mb-0 mb-sm-2">Digitação de Propostas</h1>
...
<div class="content">
    <div id="tab-prevista" class="myblock block block-rounded block-mode-loading-refresh">
        ...
        <div class="block-header block-header-default">
            <!-- <h3 class="block-title">Propostas (<a class="editable editable-click" href="javascript:void(0)"
                    id="corretor" data-type="select" data-pk="1" data-value="" data-title=""
                    style="color: rgb(93, 156, 236);">caregando...</a>)</h3> -->

            <!-- Menu de opcoes -->
            <!-- <div class="block-options">
                <a class="editable editable-click" href="javascript:void(0)" id="status" data-type="select" data-pk="1"
                    data-value="1" data-title="Escolha o Status" style="color: rgb(93, 156, 236);">carregando...</a>
            </div> -->
            <!-- END Menu de opcoes -->
            ...
            <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm">
                <thead>
                    <tr class="text-uppercase">
                        ...
                        <th style="width: 200px;">Valor Solicitado</th>
                    </tr>
                </thead>
...
async function getPropostas() {
    ...
    propostas.filter(p => p.statusdaoportunidadeid === '2').map(m => {

        // console.log(m);
        propostasPai.append(`
        <tr class="bloco propostas">
                        <td colspan="2">
                            <a class="font-w600" href="fuv-digitacao-manage.php?id=${m.id}">${m.contato}</a>
