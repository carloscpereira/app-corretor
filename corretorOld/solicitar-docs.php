...
<?php 
    ...
    $sql = "SELECT idoperadora, primeirapaga, primeiraparcela, time_assinatura_proposta, proposta_digital, idtipodeproposta, idformadepagamento FROM contatos WHERE md5(cast(idcontato as VARCHAR))='$idcontato'";
    $result = pg_query($sql);
